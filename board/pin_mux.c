...
- {pin_num: '88', pin_signal: PIO0_5/FC4_RXD_SDA_MOSI_DATA/CTIMER3_MAT0/SCT_GPI5/FC3_RTS_SCL_SSEL1/MCLK/SECURE_GPIO0_5, label: 'S1/J10[1]/U3[12]/P17[8]/P7[7]/U11[4]/P0_5-ISP1',
  identifier: SWITCH_BOARD_1;BUTTON_MAIN}
...
- {pin_num: '11', pin_signal: PIO1_0/FC0_RTS_SCL_SSEL1/SD0_D3/CT_INP2/SCT_GPI4/PLU_OUT3/ADC0_11, label: 'U20[2]/SD0_D3', identifier: SENSOR_1_INT}
- {pin_num: '59', pin_signal: PIO1_1/FC3_RXD_SDA_MOSI_DATA/CT_INP3/SCT_GPI5/HS_SPI_SSEL1/USB1_OVERCURRENTN/PLU_OUT4, label: 'P17[15]/P23[3]/LSPI_HS_SSEL1', identifier: SENSOR_2_INT}
- {pin_num: '61', pin_signal: PIO1_2/CTIMER0_MAT3/SCT_GPI6/HS_SPI_SCK/USB1_PORTPWRN/PLU_OUT5, label: 'P17[9]/P23[4]/LSPI_HS_SCK', identifier: SENSOR_3_XSHUT}
- {pin_num: '62', pin_signal: PIO1_3/SCT0_OUT4/HS_SPI_MISO/USB0_PORTPWRN/PLU_OUT6, label: 'P17[11]/P23[5]/LSPI_HS_MISO', identifier: SENSOR_3_INT}
...
- {pin_num: '91', pin_signal: PIO1_31/MCLK/SD1_CLK/CTIMER0_MAT2/SCT0_OUT6/PLU_IN0, label: 'P19[7]/P19[8]/PLU_IN0/GPIO', identifier: UART_TX_Enable;PINCE_TX_Enable}
...
- pin_list:
  ...
  - {pin_num: '14', peripheral: GPIO, signal: 'PIO0, 16', pin_signal: PIO0_16/FC4_TXD_SCL_MISO_WS/CLKOUT/CT_INP4/SECURE_GPIO0_16/ADC0_8, direction: OUTPUT, gpio_init_state: 'true'}
  ...
  - {pin_num: '88', peripheral: GPIO, signal: 'PIO0, 5', pin_signal: PIO0_5/FC4_RXD_SDA_MOSI_DATA/CTIMER3_MAT0/SCT_GPI5/FC3_RTS_SCL_SSEL1/MCLK/SECURE_GPIO0_5, identifier: BUTTON_MAIN}
...
void BOARD_InitDEBUG_UARTPins(void)
{
    ...
    gpio_pin_config_t SENSOR_1_XSHUT_config = {
    ...
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_MOTOR_A_DIRECTION_GPIO, BOARD_INITDEBUG_UARTPINS_MOTOR_A_DIRECTION_PORT, BOARD_INITDEBUG_UARTPINS_MOTOR_A_DIRECTION_PIN, &MOTOR_A_DIRECTION_config);

    gpio_pin_config_t MOTOR_ENABLE_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    ...
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_SENSOR_2_XSHUT_GPIO, BOARD_INITDEBUG_UARTPINS_SENSOR_2_XSHUT_PORT, BOARD_INITDEBUG_UARTPINS_SENSOR_2_XSHUT_PIN, &SENSOR_2_XSHUT_config);

    gpio_pin_config_t SENSOR_1_INT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_0 (pin 11)  */
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_SENSOR_1_INT_GPIO, BOARD_INITDEBUG_UARTPINS_SENSOR_1_INT_PORT, BOARD_INITDEBUG_UARTPINS_SENSOR_1_INT_PIN, &SENSOR_1_INT_config);

    gpio_pin_config_t SENSOR_3_XSHUT_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_2 (pin 61)  */
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_SENSOR_3_XSHUT_GPIO, BOARD_INITDEBUG_UARTPINS_SENSOR_3_XSHUT_PORT, BOARD_INITDEBUG_UARTPINS_SENSOR_3_XSHUT_PIN, &SENSOR_3_XSHUT_config);
    ...
    gpio_pin_config_t SENSOR_4_XSHUT_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO1_5 (pin 31)  */
    GPIO_PinInit(BOARD_INITDEBUG_UARTPINS_SENSOR_4_XSHUT_GPIO, BOARD_INITDEBUG_UARTPINS_SENSOR_4_XSHUT_PORT, BOARD_INITDEBUG_UARTPINS_SENSOR_4_XSHUT_PIN, &SENSOR_4_XSHUT_config);
    ...
    IOCON->PIO[0][23] = ((IOCON->PIO[0][23] &
                         ...
                         /* Selects pin function.
                          * : PORT023 (pin 20) is configured as CTIMER1_MAT2. */
                         | IOCON_PIO_FUNC(PIO0_23_FUNC_ALT2)
    ...
    IOCON->PIO[1][27] = ((IOCON->PIO[1][27] &
                         ...
                         /* Selects pin function.
                          * : PORT127 (pin 85) is configured as CTIMER0_MAT3. */
                         | IOCON_PIO_FUNC(PIO1_27_FUNC_ALT3)
...
- options: {callFromInitBoot: 'false', coreID: cm33_core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '88', peripheral: GPIO, signal: 'PIO0, 5', pin_signal: PIO0_5/FC4_RXD_SDA_MOSI_DATA/CTIMER3_MAT0/SCT_GPI5/FC3_RTS_SCL_SSEL1/MCLK/SECURE_GPIO0_5, identifier: SWITCH_BOARD_1,
...
void BOARD_InitBUTTONsPins(void)
{
    ...
    gpio_pin_config_t SWITCH_BOARD_1_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_5 (pin 88)  */
    GPIO_PinInit(BOARD_INITBUTTONSPINS_SWITCH_BOARD_1_GPIO, BOARD_INITBUTTONSPINS_SWITCH_BOARD_1_PORT, BOARD_INITBUTTONSPINS_SWITCH_BOARD_1_PIN, &SWITCH_BOARD_1_config);
    ...
    /* Initialize GPIO functionality on pin PIO1_9 (pin 10)  */
    GPIO_PinInit(BOARD_INITBUTTONSPINS_SWITCH_BOARD_2_GPIO, BOARD_INITBUTTONSPINS_SWITCH_BOARD_2_PORT, BOARD_INITBUTTONSPINS_SWITCH_BOARD_2_PIN, &SWITCH_BOARD_2_config);
    ...
    const uint32_t SWITCH_BOARD_1 = (/* Pin is configured as PIO0_5 */
                                     IOCON_PIO_FUNC0 |
                                     /* Selects pull-up function */
                                     IOCON_PIO_MODE_PULLUP |
                                     /* Standard mode, output slew rate control is enabled */
    ...
    IOCON_PinMuxSet(IOCON, BOARD_INITBUTTONSPINS_SWITCH_BOARD_1_PORT, BOARD_INITBUTTONSPINS_SWITCH_BOARD_1_PIN, SWITCH_BOARD_1);
    ...
    if (Chip_GetVersion()==1)
    {
        const uint32_t SWITCH_BOARD_2 = (/* Pin is configured as PIO1_9 */
                                         IOCON_PIO_FUNC0 |
                                         /* Selects pull-up function */
                                         IOCON_PIO_MODE_PULLUP |
                                         /* Standard mode, output slew rate control is enabled */
        ...
        IOCON_PinMuxSet(IOCON, BOARD_INITBUTTONSPINS_SWITCH_BOARD_2_PORT, BOARD_INITBUTTONSPINS_SWITCH_BOARD_2_PIN, SWITCH_BOARD_2);
    }
    else
    {
        const uint32_t SWITCH_BOARD_2 = (/* Pin is configured as PIO1_9 */
...
- pin_list:
  ...
  - {pin_num: '30', peripheral: FLEXCOMM4, signal: RXD_SDA_MOSI_DATA, pin_signal: PIO1_21/FC7_CTS_SDA_SSEL0/CTIMER3_MAT2/FC4_RXD_SDA_MOSI_DATA/PLU_OUT3, mode: pullUp,
    slew_rate: standard, invert: disabled, open_drain: disabled}
  - {pin_num: '91', peripheral: SYSCON, signal: MCLK, pin_signal: PIO1_31/MCLK/SD1_CLK/CTIMER0_MAT2/SCT0_OUT6/PLU_IN0, identifier: UART_TX_Enable, mode: inactive,
    slew_rate: standard, invert: disabled, open_drain: disabled}
